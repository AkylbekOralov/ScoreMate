                ...
                if let matchesData = data.data {
                    for matchData in matchesData {
                        ...
                        let match = MatchModel(
                            ...
                            leagueName: matchData.league?.name ?? "Unknown league",
                            leagueCountryName: matchData.league?.countryName ?? "Unknown country",
                            groupName: matchData.groupName ?? "Unknown group",
                            stageName: matchData.stageName ?? "Unknown stage",
